...
/**
 * Block class that adds CSS length unit input validation to a widget form element
 *
 * @category    Stabilis
 * @package     Stabilis_Core
 * @author      Luke A. Leber <lukeleber@gmail.com>
 */
class Stabilis_Core_Block_Adminhtml_Widget_Form_Renderer_Element_Css_Length extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element {
    ...
    public function render(Varien_Data_Form_Element_Abstract $element) {
        ...
        $element->addClass('validate-modern-css-length');
