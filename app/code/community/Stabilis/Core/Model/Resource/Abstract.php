...
/**
 * Abstract resource model class for all Stabilis extensions.
 *
 * @category    Stabilis
 * @package     Stabilis_Slider
 * @author      Luke A. Leber <lukeleber@gmail.com>
 * 
 */
abstract class Stabilis_Core_Model_Resource_Abstract extends Mage_Core_Model_Resource_Db_Abstract {
